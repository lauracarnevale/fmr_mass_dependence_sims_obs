...
def switch_sim(WHICH_SIM):
    if (WHICH_SIM.upper() == "TNG"):
        ...
        out_dir   = base 
        snapshots = [99] #, 91, 78, 67, 59, 50] #,50,33,25,21,17,13,11,8] # 6,4
        snap2z = {
            99:'z=0',
            91:'z=0.1',
            78:'z=0.3',
        ...
        out_dir   = base
        snapshots = [135] #, 127, 113, 103, 95, 85] #,86,68,60,54,49,45,41,38] # 35,32
        snap2z = {
            135:'z=0',
            127:'z=0.1',
            113:'z=0.3',
        ...
        snapshots = [28] #, 27, 25, 23, 21, 19] #,19,15,12,10,8,6,5,4] # 3,2
        snap2z = {
            28:'z=0',
            27:'z=0.1',
            25:'z=0.3',
        ...
        snapshots = [151] #, 145, 134, 125, 116, 105] #, 105, 79, 62, 51, 42, 36, 30, 26]
        snap2z = {
            151:'z=0',
            145:'z=0.1',
            134:'z=0.3',
